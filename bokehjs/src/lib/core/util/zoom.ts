...
export function scale_highlow(range: Interval, factor: number, center?: number): Bounds {
...
export function scale_range(x_scales: Scales, y_scales: Scales, x_range: Interval, y_range: Interval, factor: number,
    x_axis: boolean = true, y_axis: boolean = true, center?: {x: number, y: number}): ScaleRanges {
  /*
